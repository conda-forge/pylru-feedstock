...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pylru-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8296&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pylru-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pylru` can be installed with:

```
conda install pylru
```

It is possible to list all of the versions of `pylru` available on your platform with:
